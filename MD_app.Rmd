...
```{r Preparation donnees de références, include = FALSE}
...
```{r Interface utilisateur, include= FALSE}
...
```{r Serveur application, include = FALSE}
...
```{r Lancement application, echo = FALSE}
